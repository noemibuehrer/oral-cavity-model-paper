...
def main():
    ...
    nrows, ncols = 2, 1
    prevalences_file = PREVALENCES_DIR / "midline+II_I+IV_V_midline_scenarios_II_III_IV.hdf5"
    ...
    for lnl in ['II', 'III', 'IV']:
        output_path = FIGURES_DIR / f"midline_II_I_IV_V_prevalences_LNL{lnl}.pdf"
